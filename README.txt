...
a persistence unit "prueba63_AlvaradoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63_Alvarado/pom.xml":
...
artifact ("prueba63_Alvarado.war") is already built. You can build
