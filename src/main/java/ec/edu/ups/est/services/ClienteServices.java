...
import ec.edu.ups.est.business.GestionClientes;
	...
	//El usuario sabe la cedula
		...
		public Response leer(@QueryParam("dni") String cedula, @QueryParam("nombre") String nombre) {
			try {
				...
				Cliente cli = gClientes.getPersonaCedula(cedula);
		...
		public Response getClientes(){
			List<Cliente> clientes = gClientes.getAll();
			if(clientes.size()>0)
